...
import { MessageSquare, X, Send, Bot, Sparkles, Loader2, ChevronRight, HelpCircle } from 'lucide-react';
...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {isOpen && (
        <div className="w-[400px] max-w-[calc(100vw-2rem)] h-[540px] max-h-[calc(100dvh-120px)] rounded-2xl border border-border/80 bg-card/85 shadow-2xl flex flex-col overflow-hidden backdrop-blur-xl transition-all duration-300 animate-in fade-in slide-in-from-bottom-5">
          {/* Top glowing strip */}
